...
void layout_and_guide_acceptance() {
    ...
    check(current.find("\"version\":\"0.16\"")!=std::string::npos&&encode(decode(current))==current,
        "Native 0.16 roundtrip preserves Guide/Grid/Margin definitions and IDs");
    ...
    check(replace_all(legacy,"\"version\":\"0.16\"","\"version\":\"0.13\"")==1,
