...
**State:** Working branch `codex/practical-alpha`; R4 qualification source baseline `7db1f761f89a4710784e7d8da50ba94dfd6f97f1`. R1–R4 source, binary and evidence identities are in `docs/p01-qualification.md`; exact current branch HEAD is read from Git after each checkpoint synchronization. R4 Worker completed and was interrupted to mark done; no active child Worker, owned Nect Window or in-flight product mutation remains. The current Sol Task is the single writer for the rest of P01.
